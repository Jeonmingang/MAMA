...
import com.minkang.ultimate.tutorial.TutorialCommand;
import com.minkang.ultimate.tutorial.TutorialListener;
import com.minkang.ultimate.tutorial.TutorialManager;
...
// Tutorial system (rebuilt)
{
    com.minkang.ultimate.tutorial.TutorialManager tman = new com.minkang.ultimate.tutorial.TutorialManager(this);
    getServer().getPluginManager().registerEvents(new com.minkang.ultimate.tutorial.TutorialListener(tman), this);
    if (getCommand("튜토리얼") != null) getCommand("튜토리얼").setExecutor(new com.minkang.ultimate.tutorial.TutorialCommand(tman));
}
...
KitManager kitManager = KitManager.getInstance();
        ...
        TutorialManager tutorial = new TutorialManager(this);
        getServer().getPluginManager().registerEvents(new TutorialListener(tutorial), this);
        if (getCommand("튜토리얼") != null) getCommand("튜토리얼").setExecutor(new TutorialCommand(tutorial));
