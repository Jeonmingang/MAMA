...
\1
    ...
    private void sendLockHelp(org.bukkit.command.CommandSender s){
        s.sendMessage(org.bukkit.ChatColor.DARK_GRAY + "====================");
        s.sendMessage(org.bukkit.ChatColor.GOLD + "" + org.bukkit.ChatColor.BOLD + "잠금 명령어");
        s.sendMessage(org.bukkit.ChatColor.GRAY + "  /잠금 시간 <분>");
        s.sendMessage(org.bukkit.ChatColor.GRAY + "  /잠금 영구");
        s.sendMessage(org.bukkit.ChatColor.GRAY + "  /잠금 추가 <플레이어>");
        s.sendMessage(org.bukkit.ChatColor.GRAY + "  /잠금 목록");
        s.sendMessage(org.bukkit.ChatColor.GRAY + "  /잠금 해제");
        s.sendMessage(org.bukkit.ChatColor.DARK_GRAY + "--------------------");
        s.sendMessage(org.bukkit.ChatColor.GRAY + "TIP: 보고 있는 블록에 적용됩니다.");
        s.sendMessage(org.bukkit.ChatColor.DARK_GRAY + "====================");
    }
